...
So I set the SAK/ATQA to 0x28/0x0008 (later corrected to the appropriate SAK bit flips). Sure enough, I was able to use my presence hack to send config changes.
